...
Mossa received an ISC grant for the extendr Object-Oriented Programming (OOP) project (vctrs/S3, S7,
and R6 support for extendr bindings). All deliverables promised in that
proposal, including work beyond what was directly funded, are now in
production in **[miniextendr](https://a2-ai.github.io/miniextendr/)** (a separate package). They are currently
undergoing user testing before being marshalled into extendr proper.
